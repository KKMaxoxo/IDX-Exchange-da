...
if token:
    ...
    params = {
        ...
        '$filter': f"ListingContractDate ge {datetime(2026, 6, 1).isoformat(timespec='milliseconds')}Z and ListingContractDate lt {datetime(2026, 7, 1).isoformat(timespec='milliseconds')}Z",
    ...
    total_records = 0
    csv_file = 'CRMLSListing202606.csv'
